...
**`r n_tier1`** tier 1 (padj < 0.01 and FC >= 1.5), **`r n_tier2`** tier 2,
near-threshold (padj < 0.01 and 4/3 <= FC < 1.5)). Of the deviating genes,
